...
(function () {
  ...
  const ES = {
    ...
    'about.subtitle': 'Padres, educadores y vecinos que trabajan por un uso más intencional de la tecnología en Pennridge.',
    ...
    'action.li1': '<strong>Construir comunidad:</strong> Ayudar a organizar un evento, una conversación o una actividad familiar; llevar Pennridge Unplugged a su escuela, vecindario o grupo comunitario; o ayudar a conectar a las familias con oportunidades libres de teléfonos y con poca tecnología.',
    'action.li2': '<strong>Colaborar a nivel local:</strong> Trabajar con escuelas, organizaciones y negocios para crear espacios y prácticas que apoyen el uso intencional de la tecnología.',
    'action.li3': '<strong>Alzar la voz:</strong> Asistir a las reuniones de la junta escolar y compartir su perspectiva durante los comentarios públicos, conectar con líderes escolares y del distrito, o abogar a nivel del condado y del estado por políticas que apoyen un uso saludable de la tecnología y el bienestar de los niños.',
    'action.li4': '<strong>Aportar sus habilidades:</strong> Compartir información y recursos, crear contactos o aportar sus ideas y experiencia a un proyecto que le interese.',
